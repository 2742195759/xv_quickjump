import vim
import traceback
from xvutils import vim_utils
import time
from xvutils.func_register import vim_register
import threading
import subprocess
from functools import partial
import re
from xvutils.log import log
import threading
from xvutils.vim_utils import VimWindow
...
@vim_register("quickjump", command="QuickJump", with_args=False)
def QuickJump(args):
    try:
...
@vim_register("quickjump", command="BufferJump", with_args=True)
def BufferJump(args):
...
@vim_register("quickjump", command="WindowJump", with_args=True)
def WindowJump(args):
...
@vim_register("quickjump", command="GlobalJump", with_args=True)
def GlobalJump(args):
    ## search all the matches
